Locales['fr'] = {
  ...
  ['command_setorga'] = 'assigner une organisation à un joueur',
  ['command_setorga_orga'] = 'nom de l\'organisation',
  ['command_setorga_grade'] = 'grade de l\'organisation',
  ['command_setorga_invalid'] = 'l\'organisation, le grade ou les deux sont invalides',
